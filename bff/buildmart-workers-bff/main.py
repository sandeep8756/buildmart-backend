...
app = FastAPI(title="BuildMart Workers BFF", version="1.0.0")
origins = ["*"]
...
async def health_check():
    return {
        "service": "buildmart-workers-bff",
        "core": os.environ.get("ip_port", "localhost:8002"),
    }
...
app.include_router(v1, prefix="/buildmart-workers-bff")
app.include_router(common_v1, prefix="/buildmart-workers-bff/common")
