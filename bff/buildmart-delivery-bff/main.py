...
app = FastAPI(title="BuildMart Delivery BFF", version="1.0.0")
origins = ["*"]
...
async def health_check():
    return {
        "service": "buildmart-delivery-bff",
        "core": os.environ.get("ip_port", "localhost:8003"),
    }
...
app.include_router(v1, prefix="/buildmart-delivery-bff")
app.include_router(common_v1, prefix="/buildmart-delivery-bff/common")
