...
app = FastAPI(title="BuildMart Delivery Core", version="1.0.0")
...
@app.get("/")
async def root():
    return {"service": "buildmart-delivery", "host": os.environ.get("HOSTNAME", "local")}
...
app.include_router(v1, prefix="/buildmart-delivery")
app.include_router(common_v1, prefix="/buildmart-delivery/common")
