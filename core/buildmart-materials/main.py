...
app = FastAPI(title="BuildMart Materials Core", version="1.0.0")
...
@app.get("/")
async def root():
    return {"service": "buildmart-materials", "host": os.environ.get("HOSTNAME", "local")}
...
app.include_router(v1, prefix="/buildmart-materials")
app.include_router(common_v1, prefix="/buildmart-materials/common")
